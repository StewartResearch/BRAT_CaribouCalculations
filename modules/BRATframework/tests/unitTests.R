...
test_dir("C:/Users/admin-fstewart/Desktop/GitHub/BRAT_CaribouCalculations-master/modules/BRATframework/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/admin-fstewart/Desktop/GitHub/BRAT_CaribouCalculations-master/modules/BRATframework/tests/testthat/test-template.R")
