...
# Determining what vlaues should go into the Initial Frequency of a Threat (Blue boxes), and what values should go into the barriers to a threat (White
...
## (ie. known mortality or recruitment)
####### Initial event frequencies are things that we need to find out
...
#postMitigate <- postMitigate(topEvent, mitigate(0.814, 1, 1)) # this is the wolfcull lever - acting solo
#postMitigate <- postMitigate(topEvent, mitigate(1, 1, 0.95)) # this is seismic lines - acting solo
#postMitigate <- postMitigate(topEvent, mitigate(1, 0.95, 0.95)) # this is seismic lines - acting solo
